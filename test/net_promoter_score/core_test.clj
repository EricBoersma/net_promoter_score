...
(deftest get-promoter-score-test
  (testing "Correctly calculates the NPS based on some large number of values"
           (is (= 0 (nps-core/get-promoter-score (->> [] (get-random-detractor-values 10) (get-random-passive-values 10) (get-random-promoter-values 10)))))
           (is (= 66 (nps-core/get-promoter-score (->> [] (get-random-detractor-values 10) (get-random-passive-values 10) (get-random-promoter-values 70)))))
           (is (= 70 (nps-core/get-promoter-score (->> [] (get-random-detractor-values 100) (get-random-passive-values 100) (get-random-promoter-values 800)))))
           (is (= -70 (nps-core/get-promoter-score (->> [] (get-random-detractor-values 8000) (get-random-passive-values 1000) (get-random-promoter-values 1000)))))
  ...
  (testing "Correctly validates provided function parameters"
           ...
           (is (thrown? AssertionError (nps-core/get-promoter-score [])))
...
(deftest get-promoter-summary-test
  ...
  (testing "Correctly validates provided function parameters"
           ...
           (is (thrown? AssertionError (nps-core/get-promoter-summary [])))
